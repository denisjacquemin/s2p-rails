class EmojiPicker {
    ...
    initiate() {
        ...
        emojiInputs.forEach(element => {
            let emojis = []
            if (!("emojis" in element.dataset)) {
                emojis = emojis_default;
            } else {
                emojis = element.dataset.emojis.split(',');
            }
            console.log('emojis', emojis);

            this.generateElements(element, emojis);
        });
    }

    generateElements(emojiInput, emojis) {
        ...
        emojis.map(item => {
            ...
            emojiLink.innerHTML = String.fromCodePoint(parseInt(item));
