...
class CompetenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competency" do
    assert_difference('Competency.count') do
      post competencies_url, params: { competency: { name: @competency.name, school_id: @competency.school_id } }
    end
  ...
  test "should update competency" do
    patch competency_url(@competency), params: { competency: { name: @competency.name, school_id: @competency.school_id } }
