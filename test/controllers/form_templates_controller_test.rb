...
class FormTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create form_template" do
    assert_difference('FormTemplate.count') do
      post form_templates_url, params: { form_template: { author_id: @form_template.author_id, formdata: @form_template.formdata, name: @form_template.name, school_id: @form_template.school_id } }
    end
  ...
  test "should update form_template" do
    patch form_template_url(@form_template), params: { form_template: { author_id: @form_template.author_id, formdata: @form_template.formdata, name: @form_template.name, school_id: @form_template.school_id } }
