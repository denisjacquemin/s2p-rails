...
class MessageCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create message_category" do
    assert_difference('MessageCategory.count') do
      post message_categories_url, params: { message_category: { name: @message_category.name, school_id: @message_category.school_id } }
    end
  ...
  test "should update message_category" do
    patch message_category_url(@message_category), params: { message_category: { name: @message_category.name, school_id: @message_category.school_id } }
