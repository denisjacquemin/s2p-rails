class SchoolsController < ApplicationController
  ...
  private
    ...
    def school_params
      params.require(:school).permit(:name, :address, :phone, :email, :validation_workflow_active, :url, :send_code_title_template, :send_code_template, :sms_provision, :billing_enable, :payconiq_enable, :iscity, accounts_attributes: [:name, :payconiq_access_token, :account_number, :_destroy, :id])
    end
