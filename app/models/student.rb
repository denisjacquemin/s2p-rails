...
class Student < ApplicationRecord
  ...
  private
    ...
    def set_groups
      ...
      all_students_id = Group.where(internal_id: 'all_students', school_id: self.school_id).pluck(:id).first
      self.groups.push(all_students_id) unless all_students_id.nil?
